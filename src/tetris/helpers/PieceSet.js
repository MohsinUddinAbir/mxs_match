...
import { toolbox, turnOriention, convertFromMapToWidth, convertFromWidthToMap } from "./utils";
...
class PieceSet {
  ...
  createAnotherPiece(nextPieceImage) {
    ...
    nextPieceImage = this.scene.add.image(20, 20, this.next_piece_name).setOrigin(0, 0);
